...
<head>
    ...
    <title>Painel de Controle - Neubeheer</title>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <table id="tblCurrentOrder" table class="table table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <th>Produtos</th>
                                        <th>Nome do Item</th>
                                        <th class='text-center'>Quantia</th>
                            ...
                            <div class="card-footer small text-muted"><i>Atualiza automaticamente a cada 5 segundos</i></div>
                        </div>
                    </div>
