...
<head>
    ...
    <title>Neubeheer | Login de usuário administrador</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="card card-login mx-auto mt-5">
            <div class="card-header">Neubeheer | Login de usuário administrador</div>
            <div class="card-body">
                <form id="loginform">
                    <center><img src = '../image/teste.png' id="image"/></center>
                    <center><label for="logo" id="logo">NEUBEHEER</label></center>
                ...
                <a href="../index.php" class="btn btn-primary btn-block">Voltar ao início</a>
            </div>
        </div>
    </div>
