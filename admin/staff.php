...
<head>
    ...
    <title>Administração de Funcionários - Neubeheer</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <hr>
                <p>Administração de Empregados Disponíveis.</p>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card mb-3">
                                    ...
                                    ?>
                                            <tr class="text-center">
                                                ...
                                                if ($staff['status'] == "Offline") {
                                                    echo "<td><span class=\"badge badge-secondary\">Inativo</span></td>";
                                                }
                            ...
                            <div class="card-footer small text-muted"><i>Senha padrão para novo usuário: 1234abcd..</i></div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card mb-3">
                            <div class="card-header">
                                ...
                                Adicionar novo funcionário</div>
                <div class=" card-body">
                                    <form action="addstaff.php" method="POST" class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0">
                                        <div class="input-group">
                                            ...
                                            <input type="text" required="required" name="staffname" class="form-control" placeholder="Novo Funcionário" aria-label="Add" aria-describedby="basic-addon2">
