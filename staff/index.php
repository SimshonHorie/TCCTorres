...
<head>
    ...
    <title>Painel de controle - Funcionários do Neubeheer</title>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <hr>
                <p>Os procedimentos relacionados às suas tarefas estão aqui.</p>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <div class="card mb-3">
                            <div class="card-header">
                                ...
                                Pedidos mais recentes prontos
                            </div>
                            <div class="card-body">
                                <table id="orderTable" class="table table-striped table-bordered width=" 100%" cellspacing="0">
                                </table>
                            </div>
                            <div class="card-footer small text-muted"><i>Atualizações a cada três segundos</i></div>
                        </div>
                    </div>
                  ...
                  Estado</div>
                <div class=" card-body">
                                    Olá , <b><?php echo $_SESSION['username'] ?></b>
                                    <hr>
