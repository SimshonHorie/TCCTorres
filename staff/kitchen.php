    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Content -->
                <h1>Painel Administrativo da Cozinha</h1>
                <hr>
                <p>Gerencie os pedidos que foram enviados até agora.</p>
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Sistema de Restaurante Neubeheer 2022</span>
                    </div>
                </div>
            </footer>
