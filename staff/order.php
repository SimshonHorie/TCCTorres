...
if ($_SESSION['user_role'] != "Funcionario") {
    echo ("<script>window.alert('Somente esses funcionarios disponíveis!'); window.location.href='index.php';</script>");
    exit();
}
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
        ...
        <a class="navbar-brand mr-1" href="index.php">Neubeheer</a>
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <hr>
                <p>Administração de novos pedidos nesta página.</p>
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div id="qtypanel" hidden="">
                                    Quantia : <input id="qty" required="required" type="number" min="1" max="50" name="qty" value="1" />
            ...
            <footer class="sticky-footer">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Neubeheer Empresa de Tcnologia 2022</span>
                    </div>
                </div>
            </footer>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Você realmente quer sair?</h5>
